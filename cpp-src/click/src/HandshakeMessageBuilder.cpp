...
HandshakeMessageBuilder *click::HandshakeMessageBuilderImpl::withControlType(const click::ValueType& control_type)
{
...
AddRobotBuilder *click::HandshakeMessageBuilderImpl::withRobot(const std::string& name)
{
...
AddRobotBuilder *click::HandshakeMessageBuilderImpl::withControlsInOrder(const std::vector<std::string>& order)
{
    m_curr_object->mutable_controlsinorder()->Assign(order.begin(), order.end());
    return this;
}

AddRobotBuilder *click::HandshakeMessageBuilderImpl::withControlTypesInOrder(const std::vector<click::ValueType>& order)
{
    for (auto & item : order) {
...
AddRobotBuilder *click::HandshakeMessageBuilderImpl::withJointSensorsInOrder(const std::vector<std::string>& order)
{
    m_curr_object->mutable_jointsensorsinorder()->Assign(order.begin(), order.end());
    return this;
}

AddRobotBuilder *click::HandshakeMessageBuilderImpl::withJointSensors(const std::vector<click::ValueType>& order)
{
    for (auto&  item : order) {
...
AddHandshakeSensorBuilder *click::HandshakeMessageBuilderImpl::withSensor(const std::string& name)
{
...
AddRobotBuilder *click::HandshakeMessageBuilderImpl::withControlEvent(const std::string& name, const click::ValueType& type)
{
...
AddRobotBuilder *click::HandshakeMessageBuilderImpl::withObjectSensors(std::vector<click::ValueType>& order)
{
    for (auto&  item : order) {
...
AddRobotBuilder *click::HandshakeMessageBuilderImpl::withTypesInOrder(const std::vector<click::ValueType> &order)
{
    for (auto&  item : order) {
