...
```bash
# Latest version
pip install agxClick -U --extra-index-url https://click-access:LVSR4CNNupvPcRcZx3aL@git.algoryx.se/api/v4/projects/262/packages/pypi/simple
# Specific version
pip install agxClick==0.1.34 --extra-index-url https://click-access:LVSR4CNNupvPcRcZx3aL@git.algoryx.se/api/v4/projects/262/packages/pypi/simple
```
