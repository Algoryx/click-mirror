...
```bash
wget --header "DEPLOY-TOKEN: F2q7LauW_d-HJ7bH37sV" -O /tmp/click-shared-focal-amd64.deb "https://git.algoryx.se/api/v4/projects/algoryx%2Fexternal%2Fclick/packages/generic/click/0.1.12/click-shared-focal-amd64.deb"
apt-get install -yf /tmp/click-shared-focal-amd64.deb
```

- Windows C++ libraries and binaries
  - [Download win32 zip](https://click-access:F2q7LauW_d-HJ7bH37sV@git.algoryx.se/api/v4/projects/262/packages/generic/click/0.1.12/click-win32-0.1.12.zip)
