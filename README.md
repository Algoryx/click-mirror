...
```bash
wget --header "DEPLOY-TOKEN: <SECRET>" -O /tmp/click-shared-focal-amd64.deb "https://git.algoryx.se/api/v4/projects/algoryx%2Fexternal%2Fclick/packages/generic/click/0.1.42/click-shared-focal-amd64.deb"
...
- Windows C++ libraries and binaries (only available to registered users at git.algoryx.se for now)
  - [Download x64 zip](https://git.algoryx.se/api/v4/projects/262/packages/generic/click/0.1.42/click-x64-0.1.42.zip)
...
4. When MR merged, [create a tag in web IDE](https://git.algoryx.se/algoryx/external/click/-/tags/new) or tag from main and push, eg `git tag 0.1.42; git push origin 0.1.42`.
